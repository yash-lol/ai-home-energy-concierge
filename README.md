...
| **`09_AI_ENHANCEMENT_PLAN.md`** | the three-tier AI split — edge classifier, NPU planner, on-device Q&A | Reviewing the AI tiers |
| **`10_DEMO_PLAN.md`** | the staged demo on real hardware, shot by shot | Demo day |
| **`11_ML_TIER_AND_DATASET.md`** | the learned tier, the session dataset, and R8 — what they measure and what they deliberately do not claim | Reviewing the `ml-dataset-and-models` branch |
